...
# Load rails+app into the master process before forking workers for super-fast worker spawn times
...
# This is where we specify the Unix data socket to listen to.
...
before_fork do |server, worker|
  ...
  # What is does is prevent the master process from holding the database connection
